package com.example.android.todoapp.fragments
...
import com.example.android.todoapp.fragments.list.ListFragmentDirections
...
class BindingAdapters {
    ...
    companion object {
        ...
        @BindingAdapter("android:navigateToAddFragment") //action name
        @JvmStatic
        ...
        fun sendDataToUpdateFragment(view: ConstraintLayout, currentItem: ToDoData) {
            //passing data between screens with nav controller
            view.setOnClickListener {
